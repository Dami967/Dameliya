...
export const rewards: Reward[] = [
  ...
  { id: 'team-spirit', category: 'medals', title: 'Дружеский дух', icon: '🤝', rarity: 'uncommon', unlocked: false, condition: 'Завершить челлендж с другом', progress: 50 },
  ...
  { id: 'legend-bg', category: 'frames', title: 'Зал легенд', icon: '🏛️', rarity: 'legendary', unlocked: false, condition: 'Победить в серии челленджей', progress: 10 },
